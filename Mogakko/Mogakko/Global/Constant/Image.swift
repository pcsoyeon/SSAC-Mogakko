...
extension Constant {
    struct Image {
        ...
        static let homeAct = UIImage(named: "homeAct")!
        static let homeInact = UIImage(named: "homeInact")!
        static let img = UIImage(named: "img")!
        static let mapMarker = UIImage(named: "map_marker")!
        static let myAct = UIImage(named: "myAct")!
        static let myInact = UIImage(named: "myInact")!
